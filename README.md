...
> ```
---
> 🔧 If you are using ESM style imports with React Native you may have to explicitly allow the `.mjs` extension by creating a `metro.config.js` at the root of your project and append the extension to `resolver.sourceExts`:
> ```js
